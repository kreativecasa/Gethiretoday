...
export const metadata = {
  title: "About - Get Hired Today",
  description: "Learn about Get Hired Today's mission to help job seekers build better resumes with AI.",
};
...
const values = [
  {
    ...
    description: "We built Get Hired Today because generic resume advice fails people. Our AI is trained to write real, specific, impactful content — not filler.",
  },
  {
    icon: Target,
      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-b from-[var(--teal-50)] to-white py-20 lg:py-28">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              Get Hired Today was built by job seekers, for job seekers. We know how painful the resume process can be — so we built the tool we always wished existed.
            </p>
          </div>
        </section>
        ...
        <section className="bg-white py-20">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed">
              ...
              <p>
                We built Get Hired Today to fix that. Our AI analyzes job descriptions, suggests powerful bullet points, scores your resume for ATS compatibility, and helps you write a cover letter tailored to each application — all in minutes.
              </p>
              <p>
        ...
        <section className="bg-white py-20">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-gray-500 mb-8">Join thousands of job seekers using Get Hired Today to land interviews faster.</p>
